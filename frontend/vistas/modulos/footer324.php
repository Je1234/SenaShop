		...
		<div class="row">
			...
			<div class="col-md-3 col-sm-6 col-xs-12 text-left infoContacto">
				...
				<h5>
					...
					<i class="fa fa-phone-square" aria-hidden="true"></i> 314 254 12478

					<br><br>

					<i class="fa fa-envelope" aria-hidden="true"></i> Senashop@gmail.com

					<br><br>

					<i class="fa fa-map-marker" aria-hidden="true"></i> Cl. 30 #3e-164 Barranquilla, Atlántico
