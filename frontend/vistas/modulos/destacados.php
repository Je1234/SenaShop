			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/backend/vistas/img/productos/accesorios/accesorio03.jpg" class="img-responsive">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<figure>
					...
					<a href="#" class="pixelProducto">
						...
						<img src="http://localhost/backend/vistas/img/productos/accesorios/accesorio02.jpg" class="img-responsive">
